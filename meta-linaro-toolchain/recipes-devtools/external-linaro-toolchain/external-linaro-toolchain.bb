...
PROVIDES = "\
	...
	glibc-thread-db \
	libgcc \
	${@base_conditional('PREFERRED_PROVIDER_linux-libc-headers', 'external-linaro-toolchain', 'linux-libc-headers linux-libc-headers-dev', '', d)} \
	${@base_conditional('PREFERRED_PROVIDER_gdbserver', 'external-linaro-toolchain', 'gdbserver', '', d)} \
	${@base_conditional('PREFERRED_PROVIDER_binutils-dev', 'external-linaro-toolchain', 'binutils-dev', '', d)} \
"
...
do_install() {
	...
	${@base_conditional('PREFERRED_PROVIDER_linux-libc-headers', 'external-linaro-toolchain', '', 'rm -rf ${D}${includedir}/asm*; rm -rf ${D}${includedir}/drm; rm -rf ${D}${includedir}/linux; rm -rf ${D}${includedir}/mtd; rm -rf ${D}${includedir}/rdma; rm -rf ${D}${includedir}/sound; rm -rf ${D}${includedir}/video; rm -rf ${D}${includedir}/xen', d)}
	${@base_conditional('PREFERRED_PROVIDER_linux-libc-headers', 'external-linaro-toolchain', '', 'rm -rf ${D}${includedir}/scsi/scsi_netlink*; rm -rf ${D}${includedir}/scsi/scsi_bsg*; rm -rf ${D}${includedir}/scsi/fc', d)}

	${@base_conditional('PREFERRED_PROVIDER_gdbserver', 'external-linaro-toolchain', '', 'rm -rf ${D}${bindir}/gdbserver', d)}
}
...
FILES_${PN} += "\
    ...
    "
FILES_${PN}-dbg += " ${libdir}/gconv/.debug ${libexecdir}/*/.debug ${base_libdir}/.debug ${libdir}/.debug"
